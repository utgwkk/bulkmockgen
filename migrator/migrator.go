...
func (m *Migrator) Migrate() error {
	...
	interfacesByPackageName := make(map[string][]string)
	for _, o := range gomockOpts {
		interfacesByPackageName[o.packageName] = append(interfacesByPackageName[o.packageName], o.targetInterfaces...)
	}
	...
	for pkgName, is := range interfacesByPackageName {
